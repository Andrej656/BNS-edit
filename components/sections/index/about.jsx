        ...
        <Section classProp={about.section}>
            <Container spacing={['verticalXXXLrg']}>
                <SectionTitle
                    title="About Us"
                    preTitle="BLOCKCITY"
                    subTitle="₿lockCity is a decentralized marketplace that supercharges your digital assets by anchoring them to Bitcoin layer-1 BTC or layer-2 STX. This dual functionality empowers your assets to generate monthly passive income just by holding them in a non-custodial wallet. It harnesses the potential of decentralized finance through stacking and lending pools, layer-2 smart contracts and utilizing the Proof of Transfer (POX) consensus mechanism. This ensures that the yields generated by Bitcoin layer-2 miners are securely redistributed to layer-1 / layer-2 users and dapps, ensuring decentralized and sustainable passive income."
                />
